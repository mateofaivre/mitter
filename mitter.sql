...
--
-- Hôte : localhost:8889
-- Généré le : mar. 28 juin 2022 à 01:32
...
INSERT INTO `user` (`idUser`, `emailUser`, `nomUser`, `prenomUser`, `username`, `date_birth`, `avatar`, `active`, `biography`, `location`, `gender`, `date_creation`, `date_connexion`, `date_modification`, `website_link`, `passwordUser`) VALUES
...
--
ALTER TABLE `publication`
  MODIFY `idPublication` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT pour la table `publication_file`
--
ALTER TABLE `publication_file`
  MODIFY `idFile` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT pour la table `publication_meta`
--
ALTER TABLE `publication_meta`
  MODIFY `idMeta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `follower`
  ADD CONSTRAINT `follower_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`idUser`);

--
-- Contraintes pour la table `following`
--
ALTER TABLE `following`
  ADD CONSTRAINT `following_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`idUser`);

--
-- Contraintes pour la table `profile_link`
--
ALTER TABLE `profile_link`
  ADD CONSTRAINT `profile_link_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`idUser`);
...
--
ALTER TABLE `publication_like`
  ADD CONSTRAINT `publication_like_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`idUser`),
